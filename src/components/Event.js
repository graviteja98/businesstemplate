...
const Event = () => {
  return (
    <Container maxWidth="md" sx={{ mt: 4, mb: 4,  backgroundColor : 'secondary.lightest' }}>
        <Typography variant='h3' align='center'>Event details</Typography>
      <Grid container spacing={4}>
        {/* Card 1 */}
        <Grid item xs={12} sm={12}>
          <Card sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row-reverse' } }}>
            <CardMedia
              component="img"
        ...
        <Grid item xs={12} sm={12}>
          <Card sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' } }}>
            ...
            <CardContent>
              ...
              <Typography variant="body1">
                Nunc eget elit nec libero facilisis finibus. Donec nec ex sed nulla tristique
                tincidunt.
              </Typography>
            </CardContent>
          </Card>
        ...
        <Grid item xs={12} sm={12}>
          <Card sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row-reverse' } }}>
            ...
            <CardContent>
              ...
              <Typography variant="body1">
                Vestibulum eget purus a ipsum dictum bibendum eu vel quam. Duis nec commodo
                sapien.
              </Typography>
            </CardContent>
          </Card>
